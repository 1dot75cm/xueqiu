...
stock_history = prefix2 + "/v5/stock/chart/kline.json?symbol=%s&begin=%s000&end=%s000&period=%s&type=%s&indicator=%s"  # 历史行情
...
sseindex_perf = "http://query.sse.com.cn/index/indexPerfDownloadExcel.do"  # 上证指数行情
...
fund_history = prefix5 + "/F10DataApi.aspx?type=lsjz"  # 历史净值
...
# baiduindex
baidu_search_live = "http://index.baidu.com/api/LiveApi/getLive"  # live
